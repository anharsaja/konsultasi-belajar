                        ...
                        <div class="col-sm">
                            <div class="mb-4">
                                <a href="{{ route('pengajuan.create') }}"
                                    class="btn btn-light waves-effect waves-light"> <i class="bx bx-plus me-1"></i>
                                    Tambah Ajuan </a>
                            </div>
                        </div>
                        <!-- end row -->
                                ...
                                <tbody>
                                    ...
                                    @foreach ($consultations as $consultation)
                                        ...
                                        badge-soft-danger', // Warna merah untuk rejected
                                                    'rescheduled' => 'badge badge-soft-primary',
                                                ]; // Warna biru untuk rescheduled
                                            @endphp
                                            <td>
                                                <span
                                            ...
                                            <td class="d-flex justify-content-start">
                                                <button @if ($consultation->status == 'pending') disabled @endif
                                                    class="btn btn-success" data-bs-toggle="modal"
                                                    data-bs-target="#addRoom{{ $consultation->id }}"
                                                    data-bs-whatever="@mdo">Notes</button>


                                                <!-- Modallll -->
                                                <div class="modal fade" id="addRoom{{ $consultation->id }}"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <form class="modal-content" method="POST">
                                                            ...
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Dosen
                                                                    Notes</h5>
                                                            </div>
                                                                ...
                                                                <div>
                                                                    <div class="mb-3">
                                                                        <label for="recipient-name"
                                                                            class="col-form-label">Issue</label>
