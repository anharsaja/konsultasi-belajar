                    ...
                    <div class="container-sm" style="max-width: 600px;">
                        ...
                        <form id="profileForm" action="{{ route('pengajuan.store') }}" method="POST">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input name="name" type="text" class="form-control disabled-input"
                                            value="{{ Auth::user()->name }}" id="basicpill-firstname-input" disabled
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <label for="basicpill-biografi-input" class="form-label">Issue (masalah)</label>
                                        <textarea name="issue" id="basicpill-biografi-input" class="form-control" rows="4"></textarea>
                                    </div>
                                </div>
                            </div>
